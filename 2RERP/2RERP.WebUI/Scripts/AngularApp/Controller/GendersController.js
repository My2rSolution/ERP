function GenderController($scope, $http) {
    $scope.Gender = {
        "gender_code": "",
        "gender_name": "",
        "audit_user_id": "",
    ...
    $scope.initialmodel = "gender_code";
    $scope.reverse = false;
    ...
    $scope.InsertGender = function () {
        $http({ method: "POST", data: $scope.Gender, url: "/Api/BasicData/Gender" }).
    ...
    // , params: { 'foobar': new Date().getTime() } 
    $scope.btnGenderUpdate = function () {
        $http({ method: "PUT", data: $scope.Gender, url: "/Api/BasicData/Gender" }).
            success(function (data, status, header, config) {
                var a = data;
                if (a != null) {
                    $scope.Genders = data;
    ...
    $http.get('/Api/BasicData/Gender').success(function (data) {
    ...
    //display add button or update button for Gender 
    $scope.DisplayUpdate = true;
    $scope.DisplayUpdatebtn = false;

    //add Gender edit button on ng-gried dynamically
    ...
    $scope.getPagedDataAsync = function (pageSize, page, searchText) {
        setTimeout(function () {
            ...
            if (searchText) {
                ...
                $http.get('/Api/BasicData/Gender').success(function (largeLoad) {
    ...
    //        { field: 'Gender_code', displayName: 'Gender Code', sortable: true, width: '150px' },
    //        { field: 'Gender_name', displayName: 'Gender Name', sortable: true, width: '150px' },
...
app.controller('GenderController', GenderController);